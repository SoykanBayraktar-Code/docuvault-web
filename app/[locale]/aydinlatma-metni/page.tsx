...
import { getKvkk } from "@/content/legal";
...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: locale === "tr" ? "/aydinlatma-metni" : "/en/aydinlatma-metni",
      languages: {
        tr: "/aydinlatma-metni",
        en: "/en/aydinlatma-metni",
        "x-default": "/aydinlatma-metni",
      },
    },
  };
}
...
export default async function KvkkPage({
  ...
  const backLabel = locale === "en" ? "Home" : "Ana Sayfa";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-3xl px-5 py-12 pb-20">
        <div className="text-center mb-12">
          ...
          {locale === "en" && (
            <p className="mt-4 text-sm text-text-tertiary leading-relaxed max-w-xl mx-auto italic">
              This document concerns Turkish Personal Data Protection Law
              (KVKK). It is provided in Turkish as it pertains specifically to
              Turkish data subjects. For general privacy information in
              English, please see our{" "}
              <Link
                href="/privacy"
