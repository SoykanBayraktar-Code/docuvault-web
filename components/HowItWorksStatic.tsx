...
/**
 * Sequential, fully static "how it works" — the SSR output and the
 * mobile / reduced-motion fallback. All step copy lives here in the DOM
 * (accessible + indexable); the pinned 3D variant mirrors the same text.
 */
