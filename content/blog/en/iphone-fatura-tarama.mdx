...
Install DocuVault from the [App Store](https://apps.apple.com/tr/app/docuvault-belge-kasas%C4%B1/id6762083376?l=tr) and follow the flow:
...
1. **Stored encrypted with AES-256** (at rest, on EU-based endpoints) in the cloud
2. **All transport over TLS 1.2+** — access is restricted to your account with row-level security (RLS)
