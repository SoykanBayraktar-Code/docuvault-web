...
**In the local archive:** **AES-256** symmetric encryption. NIST-approved industry standard. With today's combined computing power, breaking an AES-256-encrypted file would theoretically take **trillions of years**.
...
A modern document management app **encrypts the local archive with AES-256**, **transmits cloud backups over TLS**, and **stores them encrypted** in the cloud. Both layers are secure, and a device loss leaves you with the cloud backup.
